...
const UserContainer = ({ user, deleteUser }) => {

	const roleStyle = user.type === "Admin" ? "#FFD700" : "gray.300"
		...
		<Container bg={ roleStyle } borderRadius={15} p={12}>
				<ul>
					...
					<li className="flex items-center gap-2">
						...
						<Editable defaultValue={user.type}>
					...
					<li className="flex justify-center gap-1 mt-3">
						<Button bg="red.500" borderRadius={5} onClick={deleteUser}>
							Delete User
						</Button>
					</li>
				</ul>
